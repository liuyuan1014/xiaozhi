...
import com.atcsm.java.ai.langchain4j.mapper.AppointmentMapper;
import com.atcsm.java.ai.langchain4j.service.AppointmentService;
...
public class AppointmentTools {
    ...
    @Tool(name = "预约挂号",value = "根据参数，先执行工具方法queryDepartment查询是否可预约，并直接给用户回答是否可预约，并让用户确认.如果用户没有提供具体的医生姓名，请从向量存储中找到一位医生。")
